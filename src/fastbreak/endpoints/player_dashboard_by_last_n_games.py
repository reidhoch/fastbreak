"""Player Dashboard by Last N Games endpoint for rolling averages."""
...
class PlayerDashboardByLastNGames(Endpoint[PlayerDashboardByLastNGamesResponse]):
    """Fetch player stats with rolling averages by recent games.

    Returns stats for overall, last 5/10/15/20 games, and by game number ranges.
    ...
    path: ClassVar[str] = "playerdashboardbylastngames"
    response_model: ClassVar[type[PlayerDashboardByLastNGamesResponse]] = (
        PlayerDashboardByLastNGamesResponse
    )
