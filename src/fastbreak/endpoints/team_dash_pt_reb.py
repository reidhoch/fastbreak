"""Endpoint for fetching team rebounding statistics."""
...
class TeamDashPtReb(Endpoint[TeamDashPtRebResponse]):
    """Fetch team rebounding statistics with contested/uncontested breakdown.
    ...
    path: ClassVar[str] = "teamdashptreb"
    response_model: ClassVar[type[TeamDashPtRebResponse]] = TeamDashPtRebResponse
