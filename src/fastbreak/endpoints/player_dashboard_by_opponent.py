"""Player Dashboard by Opponent endpoint for player stats split by opponent."""
...
class PlayerDashboardByOpponent(
    PlayerDashboardEndpoint[PlayerDashboardByOpponentResponse]
):
    """Fetch player stats broken down by opponent.
    ...
    path: ClassVar[str] = "playerdashboardbyopponent"
    response_model: ClassVar[type[PlayerDashboardByOpponentResponse]] = (
        PlayerDashboardByOpponentResponse
    )
