"""Endpoint for fetching team lineup statistics."""
...
class TeamDashLineups(Endpoint[TeamDashLineupsResponse]):
    """Fetch team lineup combination statistics.

    Returns stats for all lineup combinations of the specified size
    (e.g., 5-man lineups, 2-man combinations).
    ...
    path: ClassVar[str] = "teamdashlineups"
    response_model: ClassVar[type[TeamDashLineupsResponse]] = TeamDashLineupsResponse
