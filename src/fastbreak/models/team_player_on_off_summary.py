...
class TeamPlayerOnOffSummaryResponse(FrozenResponse):
    ...
    players_on_court: list[PlayerOnOffSummary] = Field(
        default_factory=list[PlayerOnOffSummary]
    )
    players_off_court: list[PlayerOnOffSummary] = Field(
        default_factory=list[PlayerOnOffSummary]
    )
    ...
    from_result_sets = model_validator(mode="before")(
        named_result_sets_validator(
            {
                "overall": ("OverallTeamPlayerOnOffSummary", True),
                "players_on_court": "PlayersOnCourtTeamPlayerOnOffSummary",
                "players_off_court": "PlayersOffCourtTeamPlayerOnOffSummary",
            }
        )
    )
