"""Models for the League Dashboard Lineups endpoint response."""
...
class LeagueLineup(PandasMixin, PolarsMixin, BaseModel):
    """Stats for a lineup combination across the league."""
    ...
    sum_time_played: int | None = Field(default=None, alias="SUM_TIME_PLAYED")
...
class LeagueDashLineupsResponse(FrozenResponse):
    """Response from the league dashboard lineups endpoint.
