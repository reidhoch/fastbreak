...
class TestTeamDashboardByGeneralSplits:
    """Tests for TeamDashboardByGeneralSplits endpoint."""
    ...
    def test_init_with_team_id(self):
        """TeamDashboardByGeneralSplits accepts team_id."""
        endpoint = TeamDashboardByGeneralSplits(team_id=1610612743)
